...
Copyright © 2026 Aaron Kyle Solomon.

## Computational companion

The program code under `src/`, the tests under `tests/`, the machine-readable
examples under `examples/`, the workflow configuration, and verification
scripts are free software licensed under the GNU General Public License,
...
The technical HTML and CSS implementation may be modified and redistributed
